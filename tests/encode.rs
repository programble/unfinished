...
test_encode! {
    ...
    Add::Rm8Imm8(M8(Offset64(None, BaseDisp(Rax, Disp8(0x01)))), Imm8(0x02)) => "80 40 01 02",
    Add::Rm8Imm8(M8(Offset64(None, BaseDisp(Rcx, Disp8(0x01)))), Imm8(0x02)) => "80 41 01 02",
    Add::Rm8Imm8(M8(Offset64(None, BaseDisp(Rdx, Disp8(0x01)))), Imm8(0x02)) => "80 42 01 02",
    Add::Rm8Imm8(M8(Offset64(None, BaseDisp(Rbx, Disp8(0x01)))), Imm8(0x02)) => "80 43 01 02",
    Add::Rm8Imm8(M8(Offset64(None, BaseDisp(Rsp, Disp8(0x01)))), Imm8(0x02)) => "80 44 24 01 02",
    Add::Rm8Imm8(M8(Offset64(None, BaseDisp(Rbp, Disp8(0x01)))), Imm8(0x02)) => "80 45 01 02",
    Add::Rm8Imm8(M8(Offset64(None, BaseDisp(Rsi, Disp8(0x01)))), Imm8(0x02)) => "80 46 01 02",
    Add::Rm8Imm8(M8(Offset64(None, BaseDisp(Rdi, Disp8(0x01)))), Imm8(0x02)) => "80 47 01 02",
    Add::Rm8Imm8(M8(Offset64(None, BaseDisp(R8, Disp8(0x01)))), Imm8(0x02)) => "41 80 40 01 02",
    Add::Rm8Imm8(M8(Offset64(None, BaseDisp(R9, Disp8(0x01)))), Imm8(0x02)) => "41 80 41 01 02",
    Add::Rm8Imm8(M8(Offset64(None, BaseDisp(R10, Disp8(0x01)))), Imm8(0x02)) => "41 80 42 01 02",
    Add::Rm8Imm8(M8(Offset64(None, BaseDisp(R11, Disp8(0x01)))), Imm8(0x02)) => "41 80 43 01 02",
    Add::Rm8Imm8(M8(Offset64(None, BaseDisp(R12, Disp8(0x01)))), Imm8(0x02)) => "41 80 44 24 01 02",
    Add::Rm8Imm8(M8(Offset64(None, BaseDisp(R13, Disp8(0x01)))), Imm8(0x02)) => "41 80 45 01 02",
    Add::Rm8Imm8(M8(Offset64(None, BaseDisp(R14, Disp8(0x01)))), Imm8(0x02)) => "41 80 46 01 02",
    Add::Rm8Imm8(M8(Offset64(None, BaseDisp(R15, Disp8(0x01)))), Imm8(0x02)) => "41 80 47 01 02",
    ...
    Add::Rm8Imm8(M8(Offset64(None, Disp(0x01020304))), Imm8(0x05)) => "80 04 25 04 03 02 01 05",

    Add::Rm8Imm8(M8(Offset64(None, RipDisp(0x01020304))), Imm8(0x05)) => "80 05 04 03 02 01 05",

    Add::Rm8Imm8(M8(Offset32(None, RipDisp(0x01020304))), Imm8(0x05)) => "67 80 05 04 03 02 01 05",
