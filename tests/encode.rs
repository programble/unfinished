...
test_encode! {
    ...
    add_rm8l_imm8 {
        Add::Rm8lImm8(R(R8l::Al), Imm8(0x01)) => "80 c0 01",
        Add::Rm8lImm8(R(R8l::Cl), Imm8(0x01)) => "80 c1 01",
        Add::Rm8lImm8(R(R8l::Dl), Imm8(0x01)) => "80 c2 01",
        Add::Rm8lImm8(R(R8l::Bl), Imm8(0x01)) => "80 c3 01",
        Add::Rm8lImm8(R(R8l::Ah), Imm8(0x01)) => "80 c4 01",
        Add::Rm8lImm8(R(R8l::Ch), Imm8(0x01)) => "80 c5 01",
        Add::Rm8lImm8(R(R8l::Dh), Imm8(0x01)) => "80 c6 01",
        Add::Rm8lImm8(R(R8l::Bh), Imm8(0x01)) => "80 c7 01",
    },

    add_rm8_imm8_r8 {
        Add::Rm8Imm8(R(Al), Imm8(0x01)) => "80 c0 01",
        Add::Rm8Imm8(R(Cl), Imm8(0x01)) => "80 c1 01",
        Add::Rm8Imm8(R(Dl), Imm8(0x01)) => "80 c2 01",
        Add::Rm8Imm8(R(Bl), Imm8(0x01)) => "80 c3 01",
        Add::Rm8Imm8(R(Spl), Imm8(0x01)) => "40 80 c4 01",
        Add::Rm8Imm8(R(Bpl), Imm8(0x01)) => "40 80 c5 01",
        Add::Rm8Imm8(R(Sil), Imm8(0x01)) => "40 80 c6 01",
        Add::Rm8Imm8(R(Dil), Imm8(0x01)) => "40 80 c7 01",
        Add::Rm8Imm8(R(R8l), Imm8(0x01)) => "41 80 c0 01",
        Add::Rm8Imm8(R(R9l), Imm8(0x01)) => "41 80 c1 01",
        Add::Rm8Imm8(R(R10l), Imm8(0x01)) => "41 80 c2 01",
        Add::Rm8Imm8(R(R11l), Imm8(0x01)) => "41 80 c3 01",
        Add::Rm8Imm8(R(R12l), Imm8(0x01)) => "41 80 c4 01",
        Add::Rm8Imm8(R(R13l), Imm8(0x01)) => "41 80 c5 01",
        Add::Rm8Imm8(R(R14l), Imm8(0x01)) => "41 80 c6 01",
        Add::Rm8Imm8(R(R15l), Imm8(0x01)) => "41 80 c7 01",
    },
    ...
    add_rm_imm {
        Add::Rm16Imm16(R(Cx), Imm16(0x0102)) => "66 81 c1 02 01",
        Add::Rm32Imm32(R(Ecx), Imm32(0x01020304)) => "81 c1 04 03 02 01",
        Add::Rm64Imm32(R(Rcx), Imm32(0x01020304)) => "48 81 c1 04 03 02 01",
    },

    add_rm_imm8 {
        Add::Rm16Imm8(R(Cx), Imm8(0x01)) => "66 83 c1 01",
        Add::Rm32Imm8(R(Ecx), Imm8(0x01)) => "83 c1 01",
        Add::Rm64Imm8(R(Rcx), Imm8(0x01)) => "48 83 c1 01",
    },

    add_rm32_imm8 {
        Add::Rm32Imm8(R(Eax), Imm8(0x01)) => "83 c0 01",
        Add::Rm32Imm8(R(Edx), Imm8(0x01)) => "83 c2 01",
        Add::Rm32Imm8(R(Ebx), Imm8(0x01)) => "83 c3 01",
        Add::Rm32Imm8(R(Esp), Imm8(0x01)) => "83 c4 01",
        Add::Rm32Imm8(R(Ebp), Imm8(0x01)) => "83 c5 01",
        Add::Rm32Imm8(R(Esi), Imm8(0x01)) => "83 c6 01",
        Add::Rm32Imm8(R(Edi), Imm8(0x01)) => "83 c7 01",
        Add::Rm32Imm8(R(R8d), Imm8(0x01)) => "41 83 c0 01",
        Add::Rm32Imm8(R(R9d), Imm8(0x01)) => "41 83 c1 01",
        Add::Rm32Imm8(R(R10d), Imm8(0x01)) => "41 83 c2 01",
        Add::Rm32Imm8(R(R11d), Imm8(0x01)) => "41 83 c3 01",
        Add::Rm32Imm8(R(R12d), Imm8(0x01)) => "41 83 c4 01",
        Add::Rm32Imm8(R(R13d), Imm8(0x01)) => "41 83 c5 01",
        Add::Rm32Imm8(R(R14d), Imm8(0x01)) => "41 83 c6 01",
        Add::Rm32Imm8(R(R15d), Imm8(0x01)) => "41 83 c7 01",
    },

    add_rm_r {
        Add::Rm8lR8l(R(R8l::Al), R8l::Cl) => "00 c8",
        Add::Rm8R8(R(Al), Cl) => "00 c8",
        Add::Rm16R16(R(Ax), Cx) => "66 01 c8",
        Add::Rm32R32(R(Eax), Ecx) => "01 c8",
        Add::Rm64R64(R(Rax), Rcx) => "48 01 c8",
    },

    add_rm32_r32 {
        Add::Rm32R32(R(Eax), Eax) => "01 c0",
        Add::Rm32R32(R(Eax), Edx) => "01 d0",
        Add::Rm32R32(R(Eax), Ebx) => "01 d8",
        Add::Rm32R32(R(Eax), Esp) => "01 e0",
        Add::Rm32R32(R(Eax), Ebp) => "01 e8",
        Add::Rm32R32(R(Eax), Esi) => "01 f0",
        Add::Rm32R32(R(Eax), Edi) => "01 f8",
        Add::Rm32R32(R(Eax), R8d) => "44 01 c0",
        Add::Rm32R32(R(Eax), R9d) => "44 01 c8",
        Add::Rm32R32(R(Eax), R10d) => "44 01 d0",
        Add::Rm32R32(R(Eax), R11d) => "44 01 d8",
        Add::Rm32R32(R(Eax), R12d) => "44 01 e0",
        Add::Rm32R32(R(Eax), R13d) => "44 01 e8",
        Add::Rm32R32(R(Eax), R14d) => "44 01 f0",
        Add::Rm32R32(R(Eax), R15d) => "44 01 f8",
    },

    add_r_rm {
        Add::R8lRm8l(R8l::Cl, R(R8l::Al)) => "02 c8",
        Add::R8Rm8(Cl, R(Al)) => "02 c8",
        Add::R16Rm16(Cx, R(Ax)) => "66 03 c8",
        Add::R32Rm32(Ecx, R(Eax)) => "03 c8",
        Add::R64Rm64(Rcx, R(Rax)) => "48 03 c8",
    },

    mov_rm16_sreg {
        Mov::Rm16Sreg(R(Ax), Es) => "8c c0",
        Mov::Rm16Sreg(R(Ax), Cs) => "8c c8",
        Mov::Rm16Sreg(R(Ax), Ss) => "8c d0",
        Mov::Rm16Sreg(R(Ax), Ds) => "8c d8",
        Mov::Rm16Sreg(R(Ax), Fs) => "8c e0",
        Mov::Rm16Sreg(R(Ax), Gs) => "8c e8",
    },

    mov_rm64_sreg {
        Mov::Rm64Sreg(R(Rax), Es) => "48 8c c0",
    },

    mov_sreg_rm16 {
        Mov::SregRm16(Es, R(Ax)) => "8e c0",
    },

    mov_sreg_rm64 {
        Mov::SregRm64(Es, R(Rax)) => "48 8e c0",
    },
